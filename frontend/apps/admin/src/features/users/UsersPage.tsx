    ...
    return (
        <div className="p-4 md:p-10 space-y-6 md:space-y-10">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
                <div>
                    <h1 className="text-2xl md:text-4xl font-[1000] text-admin-navy    leading-none mb-4">KULLANICI <span className="text-brand-pink">YÖNETİMİ</span></h1>
                    <p className="text-10px font-semibold text-slate-400    opacity-70">Sistemdeki tüm kayıtlı kullanıcıları yönet</p>
                </div>
                    ...
                    <table className="w-full min-w-[800px]">
                        <thead>
                            <tr className="border-b border-slate-50 bg-slate-50/50">
                                <th className="px-10 py-8 text-10px font-semibold text-slate-400   ">Kullanıcı</th>
                                <th className="px-10 py-8 text-10px font-semibold text-slate-400   ">İletişim</th>
                                <th className="px-10 py-8 text-10px font-semibold text-slate-400    text-center">Durum</th>
                                <th className="px-10 py-8 text-10px font-semibold text-slate-400    text-center">Kayıt Tarihi</th>
                                    ...
                                    <tr key={user.id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-10 py-8 text-center">
                                            <button
                                                ...
                                                className={`px-4 py-1.5 rounded-full text-nano font-semibold    transition-all ${user.isActive ? 'bg-emerald-100 text-emerald-600 hover:bg-emerald-200' : 'bg-rose-100 text-rose-600 hover:bg-rose-200'
                                                    }`}
                                            >
                                        ...
                                        <td className="px-10 py-8 text-center">
                                            <span className="text-10px font-semibold text-slate-400   ">{new Date(user.createdAt).toLocaleDateString('tr-TR')}</span>
                                        </td>
