                    ...
                    <div className="flex justify-between items-center h-24">
                        ...
                        <div className="flex items-center gap-16">
                            <Link to="/" className="flex items-center">
                                <span className="text-2xl font-extrabold tracking-tighter text-gray-900 italic uppercase">
                                    <span className="text-brand-pink">FUI & </span>RA
                                </span>
                            </Link>
                            <nav className="hidden lg:flex items-center gap-10 text-[10px] font-bold uppercase tracking-widest text-gray-500">
                        ...
                        <div ref={searchRef} className="flex-1 max-w-lg mx-12 hidden md:block relative">
                            ...
                            {showSuggestions && (
                                <div className="absolute top-full left-0 right-0 mt-4 bg-white rounded-md shadow-2xl border border-gray-50 overflow-hidden z-20 animate-in fade-in slide-in-from-top-2 duration-300">
                                        ...
                                        <div className="py-4">
                                            <div className="px-8 pb-4 border-b border-gray-50 mb-2 flex justify-between items-center">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">SON ARANANLAR</span>
                                                </div>
                                                <button
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                            ...
                                            {recentSearches.map((term, index) => (
                                                ...
                                                >
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <span className="text-[11px] font-bold text-gray-500 group-hover:text-gray-900 uppercase italic transition-colors truncate">{term}</span>
                                                    </div>
                                                    <button
                                                        onClick={(e) => {
                                                            e.stopPropagation();
                                                    ...
                                                    {suggestions.map((product) => (
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex-1 truncate">
                                                                <h4 className="text-[11px] font-bold text-gray-900 uppercase italic truncate leading-none mb-1.5">{product.name}</h4>
                                                                <div className="flex items-center gap-3">
                                                                    {product.discountPrice ? (
                                                                        <>
                                                                            ...
                                                                            <span className="text-[10px] font-black text-brand-pink italic">
                        ...
                        <div className="flex items-center gap-8">
                            ...
                            <div ref={cartRef} className="relative">
                                ...
                                {showCart && (
                                    <div className="absolute top-full right-0 mt-2 w-[380px] bg-white rounded-md shadow-2xl border border-gray-50 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-300">
                                            ...
                                            {items.length === 0 ? (
                                                ...
                                                items.map((item) => (
                                                    <div key={`${item.id}-${item.variant}`} className="flex gap-4 p-4 rounded-md hover:bg-gray-50 transition-colors group relative overflow-hidden">
                                                        <div className="w-20 h-20 bg-white rounded-md border border-gray-100 flex items-center justify-center p-2 flex-shrink-0 group-hover:scale-105 transition-transform">
                                                                ...
                                                                <div className="flex items-center gap-2">
                                                                    {item.originalPrice ? (
                                                                        <>
                                                                            ...
                                                                            <span className="text-xs font-black text-brand-pink italic">
                                                        ...
                                                        <button
                                                            ...
                                                            className="absolute top-1/2 -translate-y-1/2 -right-12 group-hover:right-4 w-10 h-10 rounded-md bg-white shadow-xl shadow-red-500/10 border border-gray-50 flex items-center justify-center text-gray-300 hover:text-red-500 transition-all duration-300"
                                                        >
                                        ...
                                        <div className="p-8 bg-gray-50/50 border-t border-gray-50">
                                            <div className="flex justify-between items-center mb-8">
                                                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest italic">TOPLAM TUTAR</span>
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <Link
                                                    ...
                                                    className="py-4 rounded-md bg-white border border-gray-100 text-[10px] font-black text-gray-900 uppercase tracking-widest text-center hover:bg-gray-900 hover:text-white transition-all italic"
                                                >
                                                    SEPETE GİT
                                                </Link>
                                                <Link
                                                    to="/checkout"
                                                    onClick={() => setShowCart(false)}
                                                    className="py-4 rounded-md bg-brand-pink text-white text-[10px] font-black uppercase tracking-widest text-center shadow-xl shadow-brand-pink/20 hover:scale-105 transition-all italic"
                                                >
                                                    ÖDEME YAP
                                                </Link>
                                            </div>
                                ...
                                {isAuthenticated ? (
                                    <>
                                        <button
                                            ...
                                            className={`w-10 h-10 rounded-md bg-gray-50 flex items-center justify-center border transition-all ${showUserMenu ? 'border-brand-pink ring-4 ring-brand-pink/5' : 'border-gray-100 hover:border-brand-pink'}`}
                                        >
                                        ...
                                        {showUserMenu && (
                                            <div className="absolute top-full right-0 mt-2 w-60 bg-white rounded-md shadow-2xl border border-gray-50 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-300">
                                                ...
                                                <div className="p-3">
                                                    <Link
                                                        ...
                                                        className="flex items-center gap-4 px-5 py-3.5 rounded-md text-[10px] font-black text-gray-400 uppercase tracking-widest hover:bg-gray-50 hover:text-gray-900 transition-all italic"
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full flex cursor-pointer items-center gap-4 px-5 py-3.5 rounded-md text-[10px] font-black text-red-400 uppercase tracking-widest hover:bg-red-50 transition-all italic"
                                                    >
                                    ...
                                    <Link
                                        to="/login"
                                        className="px-6 h-10 rounded-md bg-gray-900 text-white text-[10px] font-black uppercase tracking-widest flex items-center justify-center hover:bg-brand-pink transition-all shadow-lg shadow-gray-200"
                                    >
                                        GİRİŞ YAP
                                    </Link>
                                )}
            ...
            <footer className="bg-white border-t border-gray-50 pt-32 pb-16">
                <div className="max-w-[1440px] mx-auto px-4 sm:px-10 lg:px-20">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-32">
                        ...
                        <div>
                            <h4 className="text-[10px] font-bold text-gray-900 mb-10 uppercase tracking-[0.2em] italic">BÜLTENİMİZE KATILIN</h4>
                            <p className="text-[11px] font-bold text-gray-600 mb-8 italic">Özel teklifler ve ilk bakış için abone olun.</p>
                            <div className="flex flex-col gap-4">
                                <input aria-label="E-posta adresi" type="email" placeholder="E-posta adresi" className="w-full bg-gray-50 border border-gray-100 rounded-md px-6 py-4 text-xs font-bold focus:ring-4 focus:ring-brand-pink/5" />
                                <button className="w-full bg-brand-pink text-gray-900 py-3 rounded-md text-[10px] font-bold uppercase tracking-widest shadow-lg shadow-brand-pink/20 hover:bg-brand-pink-hover transition-all italic">ABONE OL</button>
                            </div>
                        </div>
                    </div>
