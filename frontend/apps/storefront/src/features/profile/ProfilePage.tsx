...
const ProfilePage: React.FC = () => {
    ...
    const handleSaveProfile = async () => {
        ...
        // +90 tek başına ise boş kabul et
                ...
                return (
                    <div className="space-y-16 animate-in fade-in duration-500">
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 pb-12 border-b border-gray-100/50">
                            <div>
                                <h2 className="text-[40px] font-[1000] text-gray-900 tracking-tighter uppercase italic leading-none mb-4">
                            ...
                            <button onClick={handleSaveProfile} className="px-12 py-5 bg-gray-900 text-white rounded-md text-[11px] font-[1000] uppercase tracking-[0.2em] shadow-2xl shadow-gray-200 hover:bg-brand-pink hover:-translate-y-1 transition-all active:scale-95 italic text-center min-w-[240px]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
                            <div className="space-y-4">
                                ...
                                <div className="relative group">
                                    <input type="text" value={formData.firstName} readOnly disabled className="w-full h-20 px-8 bg-gray-50/50 border-2 border-gray-100 rounded-md text-sm font-bold italic text-gray-300 cursor-not-allowed" />
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="relative group">
                                    <input type="text" value={formData.lastName} readOnly disabled className="w-full h-20 px-8 bg-gray-50/50 border-2 border-gray-100 rounded-md text-sm font-bold italic text-gray-300 cursor-not-allowed" />
                                    <div className="absolute right-6 top-1/2 -translate-y-1/2 px-3 py-1 bg-gray-900 text-[8px] font-black text-white italic rounded-full opacity-0 group-hover:opacity-100 transition-opacity">SABİT</div>
                                </div>
                            </div>
                            <div className="space-y-4 md:col-span-2">
                                ...
                                <input
                                    ...
                                    className="w-full h-20 px-8 bg-white border-2 border-gray-50 rounded-md text-sm font-bold focus:outline-none focus:border-brand-pink focus:bg-white focus:ring-[12px] focus:ring-brand-pink/5 transition-all italic text-gray-900"
                                />
                            </div>
                            <div className="space-y-4 md:col-span-2">
                        ...
                        <div className="pt-20 border-t border-gray-100/50">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-12">
                                ...
                                <button onClick={handlePasswordChange} className="text-[10px] font-black italic uppercase tracking-widest px-8 py-3 bg-gray-100 rounded-md hover:bg-gray-900 hover:text-white transition-all">ŞİFREYİ DEĞİŞTİR</button>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <input
                                    ...
                                    className="w-full h-20 px-8 bg-white border-2 border-gray-50 rounded-md text-sm font-bold focus:outline-none focus:border-gray-900 transition-all italic"
                                />
                                <input
                                    type="password"
                                    autoComplete="new-password"
                ...
                return (
                    <div className="space-y-16 animate-in fade-in duration-500">
                        <div className="flex justify-between items-end pb-12 border-b border-gray-100/50">
                            <div>
                                <h2 className="text-[40px] font-[1000] text-gray-900 tracking-tighter uppercase italic leading-none mb-4">ADRES <span className="text-brand-pink">REHBERİM</span></h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="p-10 rounded-md border-2 border-brand-pink bg-rose-50/20 relative group overflow-hidden">
                                <div className="absolute top-0 right-0 px-6 py-2 bg-brand-pink text-white text-[8px] font-black uppercase tracking-widest rounded-bl-md italic">VARSAYILAN</div>
                ...
                return (
                    <div className="space-y-16 animate-in fade-in duration-500">
                        <div className="pb-12 border-b border-gray-100/50 text-left">
                            <h2 className="text-[40px] font-[1000] text-gray-900 tracking-tighter uppercase italic leading-none mb-4">BİLDİRİM <span className="text-brand-pink">TERCİHLERİ</span></h2>
        ...
        <>
            ...
            {isVerifying && (
                <div className="fixed inset-0 w-screen h-screen bg-gray-900/80 backdrop-blur-sm z-[9999] flex items-center justify-center" >
                    <div className="bg-white rounded-md p-12 max-w-md w-full shadow-2xl animate-in zoom-in duration-300">
                        ...
                        <input
                            ...
                            className="w-full h-20 bg-gray-50 border-2 border-gray-100 rounded-md text-center text-2xl font-black tracking-[0.5em] focus:outline-none focus:border-brand-pink mb-8 italic"
                        />
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <button onClick={confirmVerification} className="py-5 bg-gray-900 text-white rounded-md text-[10px] font-black italic uppercase tracking-widest hover:bg-brand-pink transition-all">ONAYLA</button>
                        </div>
                    </div>
                </div>
            )}
                ...
                <div className="flex flex-col lg:flex-row gap-16 md:gap-24">
                    ...
                    <div className="lg:w-1/3 xl:w-1/4 space-y-12">
                        <div className="relative group inline-block">
                            <div className="w-48 h-48 md:w-56 md:h-56 rounded-md bg-gray-50 border-8 border-white shadow-2xl shadow-gray-200 overflow-hidden group-hover:rotate-6 transition-all duration-700">
                            ...
                            <button className="absolute -bottom-4 -right-4 w-16 h-16 bg-gray-900 text-white rounded-md flex items-center justify-center shadow-2xl border-4 border-white hover:bg-brand-pink hover:scale-110 transition-all active:scale-90">
                        ...
                        <div className="space-y-4">
                            <h1 className="text-3xl md:text-[40px] font-[1000] text-gray-900 tracking-tighter uppercase italic leading-none">
