        ...
        >
            ...
            <div className="relative w-full sm:max-w-md bg-white rounded-md shadow-2xl z-10 overflow-hidden">
                ...
                <div className="flex items-center justify-between px-8 pt-8 pb-6 border-b border-gray-50">
                    <div>
                        <p className="text-[9px] font-black text-brand-pink tracking-[0.3em] uppercase italic mb-1">Kaydet</p>
                        <h2 className="text-xl font-[1000] text-gray-900 italic uppercase tracking-tight">Koleksiyona Ekle</h2>
                    </div>
                    <button
                        onClick={onClose}
                        aria-label="Kapat"
                    ...
                    {collections.map(col => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-[11px] font-black uppercase italic tracking-wide truncate">{col.name}</p>
