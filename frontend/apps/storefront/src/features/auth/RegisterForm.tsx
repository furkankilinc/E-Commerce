...
const RegisterForm: React.FC = () => {
    ...
    return (
        <div className="w-full max-w-[500px] bg-white rounded-3xl p-6 sm:p-10 md:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.06)] border border-gray-100/50">
            {/* Stepper */}
            <div className="mb-4">
                <div className="flex justify-between  text-9px font-semibold text-gray-300 mb-3 tracking-[0.2em]">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                        <label className="flex items-center gap-2 text-10px font-bold text-gray-400  tracking-widest ml-1">Adınız</label>
                        <input
                            type="text"
                            name="firstName"
                    ...
                    <div className="space-y-1">
                        <label className="flex items-center gap-2 text-10px font-bold text-gray-400  tracking-widest ml-1">Soyadınız</label>
                        <input
                            type="text"
                            name="lastName"
                ...
                <div className="space-y-1">
                    ...
                    {errors.password && <p className="text-9px font-semibold text-brand-pink  tracking-tighter ml-1 leading-relaxed">{errors.password}</p>}
                </div>
