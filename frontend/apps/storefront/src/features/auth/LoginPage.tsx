        ...
        <div className="min-h-screen w-full flex flex-col bg-[#fafafa] relative overflow-x-hidden font-sans selection:bg-brand-pink/10 selection:text-brand-pink">
            ...
            <header className="fixed top-0 left-0 right-0 h-16 md:h-16 px-6 md:px-12 flex items-center justify-between bg-white/60 backdrop-blur-2xl border-b border-gray-100/50 z-50 transition-all">
                <div className="flex items-center gap-2 group cursor-pointer">
                    <span className="text-xl md:text-2xl font-[1000]  text-gray-900   leading-none">
                ...
                <nav className="hidden lg:flex items-center gap-8">
                    ...
                    <Link to="/register" className="px-6 py-2 rounded-full border-2 border-gray-900 text-caption font-[1000] text-gray-900 hover:bg-gray-900 hover:text-white transition-all transform active:scale-95   shadow-sm">
                        Üye Ol
                    </Link>
                </nav>
            ...
            <div className={`fixed inset-0 bg-white z-[55] lg:hidden transition-all duration-500 ease-in-out flex flex-col ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="h-16 px-6 flex items-center justify-between border-b border-gray-50">
                    <span className="text-xl font-[1000]  text-gray-900  ">FUI<span className="text-brand-pink">RA</span></span>
                ...
                <div className="flex-1 overflow-y-auto py-6 px-6 space-y-4">
                    <button className="w-full text-left py-4 text-xl font-[1000] text-gray-900   border-b border-gray-50">MAĞAZA</button>
                    <button className="w-full text-left py-4 text-xl font-[1000] text-gray-900   border-b border-gray-50">TOPLULUK</button>
                    <button className="w-full text-left py-4 text-xl font-[1000] text-gray-900   border-b border-gray-50 flex justify-between">YENİLİKLER <span className="bg-brand-pink text-white text-nano px-2 py-0.5 rounded-full">HOT</span></button>
                </div>
                <div className="p-6 bg-[#fafafa] border-t border-gray-50 space-y-8">
                    <div className="grid grid-cols-2 gap-4">
                        <Link to="/login" className="py-4 border-2 border-gray-900 rounded-lg text-gray-900 font-[1000] text-center text-sm  ">Giriş Yap</Link>
                        <Link to="/register" className="py-4 bg-brand-pink rounded-lg text-white font-[1000] text-center text-sm  ">Üye Ol</Link>
                    </div>
                </div>
            </div>
