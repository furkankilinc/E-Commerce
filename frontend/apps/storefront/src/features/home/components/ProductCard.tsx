        ...
        <Link to={`/product/${product.id}`} className="group flex flex-col bg-white rounded-md p-4 transition-all border-2 border-transparent  hover:shadow-xl hover:shadow-gray-200/50">
            ...
            <div className="flex flex-col flex-grow px-2">
                <div className="flex justify-between items-center mb-3 ">
                    <span className="text-10px font-semibold text-gray-600 ">{product.category?.name}</span>
                ...
                <h3 className="text-base font-semibold text-gray-900 mb-4 leading-tight  group-hover:text-brand-pink transition-colors  line-clamp-2  ">{product.name}</h3>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-baseline gap-2">
                            {product.discountPrice ? (
                                <>
                                    <span className="text-xs font-semibold text-gray-400 line-through opacity-60  text-nowrap">
                                        {product.price.toLocaleString()} ₺
                                    </span>
                                    <span className="text-xl font-[1000] text-gray-900   leading-none text-nowrap">
                    ...
                    <div className="flex justify-end">
                        {product.stock > 0 ? (
                            <button
                                ...
                                className="w-fit cursor-pointer flex items-center gap-2 px-4 py-2.5 rounded-md bg-brand-pink hover:bg-brand-pink/90 active:scale-95 text-white text-10px font-semibold   transition-all shadow-brand-pink/20"
                            >
                            ...
                            <div className="w-fit px-4 py-2.5 bg-gray-100 text-gray-400 rounded-md text-nano font-semibold  border border-gray-100 flex items-center gap-2">
