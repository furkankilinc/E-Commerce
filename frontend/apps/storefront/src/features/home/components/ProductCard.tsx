    ...
    return (
        <Link to={`/product/${product.id}`} className="group flex flex-col bg-white rounded-md p-4 transition-all border-2 border-transparent  hover:shadow-xl hover:shadow-gray-200/50">
            ...
            <div className="flex flex-col flex-grow px-2">
                ...
                <h3 className="text-base font-bold text-gray-900 mb-4 leading-tight  group-hover:text-brand-pink transition-colors  line-clamp-2  ">{product.name}</h3>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-baseline gap-2">
                            {product.discountPrice ? (
                                <>
                                    <span className="text-xs font-bold text-gray-400 line-through opacity-60  text-nowrap">
                    ...
                    <div className="flex justify-end">
                        {product.stock > 0 ? (
                            <button
                                ...
                                className="w-fit cursor-pointer flex items-center gap-2 px-4 py-2.5 rounded-md bg-brand-pink hover:bg-brand-pink/90 active:scale-95 text-white text-10px font-bold   transition-all shadow-brand-pink/20"
                            >
