    ...
    return (
        <div className="flex gap-12 min-h-screen">
            ...
            <aside className="w-72 flex flex-col gap-10">
                <div>
                    <h3 className="text-10px font-semibold text-slate-400   mb-4 italic">AYARLAR</h3>
            ...
            <div className="flex-1 space-y-12">
                        ...
                        <div className="flex justify-between items-start mb-6">
                            <div className="flex items-center gap-10">
                                <div className="relative">
                                    ...
                                    <button className="absolute -bottom-2 -right-2 w-12 h-12 bg-brand-pink text-white rounded-2xl flex items-center justify-center shadow-lg border-4 border-white  transition-transform">
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                                    </button>
                                </div>
                                <div>
                                    <h1 className="text-4xl font-[1000] text-slate-900  italic mb-2">Kişisel <span className="text-brand-pink">Bilgiler</span></h1>
                                    <p className="text-slate-400 font-bold italic opacity-70  text-xs ">Fotoğrafını ve hesap detaylarını yönet</p>
                                </div>
                            </div>
                            <button onClick={handleSave} className="px-8 py-4 bg-brand-pink text-white rounded-2xl text-10px font-semibold    shadow-brand-pink/20 hover:bg-brand-pink-hover transition-all active:scale-95 italic">Değişiklikleri Kaydet</button>
                        </div>

                        <div className="grid grid-cols-2 gap-10">
                            <div className="space-y-3">
                                <label className="text-10px font-semibold text-slate-400   ml-4 italic">ADINIZ</label>
                            ...
                            <div className="space-y-3">
                                <label className="text-10px font-semibold text-slate-400   ml-4 italic">SOYADINIZ</label>
                            ...
                            <div className="space-y-3">
                                <label className="text-10px font-semibold text-slate-400   ml-4 italic">E-POSTA ADRESİ</label>
                            ...
                            <div className="space-y-3">
                                <label className="text-10px font-semibold text-slate-400   ml-4 italic">TELEFON NUMARASI</label>
                ...
                {activeTab === 'addresses' && (
                    <div className="bg-white p-12 rounded-xl shadow-sm border border-slate-50">
                        <div className="flex justify-between items-center mb-6">
                            <div>
                                <h2 className="text-3xl font-[1000] text-slate-900  italic mb-2">Adres <span className="text-brand-pink">Yönetimi</span></h2>
                                <p className="text-slate-400 font-bold italic opacity-70  text-xs ">Teslimat ve fatura adreslerini düzenle</p>
                            </div>
                            <button className="flex items-center gap-3 text-brand-pink font-semibold text-xs   italic hover:translate-x-1 transition-transform">
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            ...
                            <div className="p-8 rounded-xl border-2 border-brand-pink bg-rose-50/20 relative overflow-hidden group">
                                <div className="absolute top-0 right-0 px-6 py-2 bg-brand-pink text-white text-micro font-semibold   rounded-bl-[1.5rem] italic">VARSAYILAN</div>
                                ...
                                <div className="flex gap-6 mt-auto">
                                    <button className="text-10px font-semibold text-brand-pink   italic hover:opacity-100 opacity-60 transition-opacity">Düzenle</button>
                                    <button className="text-10px font-semibold text-rose-400   italic hover:opacity-100 opacity-60 transition-opacity">Sil</button>
                                </div>
                            </div>
                ...
                {activeTab === 'security' && (
                    <div className="bg-white p-12 rounded-xl shadow-sm border border-slate-50">
                        <div className="mb-6">
                            <h2 className="text-3xl font-[1000] text-slate-900  italic mb-2">Güvenlik <span className="text-brand-pink">&</span> Erişim</h2>
                            <p className="text-slate-400 font-bold italic opacity-70  text-xs ">Hesap güvenliğini ve şifreni güncelle</p>
                        </div>

                        <div className="space-y-10">
                            <div className="grid grid-cols-1 gap-8 max-w-2xl">
                                <div className="space-y-3">
                                    <label className="text-10px font-semibold text-slate-400   ml-4 italic">MEVCUT ŞİFRE</label>
                                    <div className="relative">
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        <label className="text-10px font-semibold text-slate-400   ml-4 italic">YENİ ŞİFRE</label>
                                    ...
                                    <div className="space-y-3">
                                        <label className="text-10px font-semibold text-slate-400   ml-4 italic">ŞİFRE TEKRAR</label>
                            ...
                            <button className="px-12 py-5 bg-slate-900 text-white rounded-2xl text-caption font-semibold   hover:bg-slate-800 transition-all active:scale-95 italic">Şifreyi Güncelle</button>
                            ...
                            <div className="flex items-center justify-between p-8 rounded-xl bg-slate-50 border border-slate-100">
                                <div>
                                    ...
                                    <p className="text-xs font-bold text-slate-400 italic opacity-80  ">Hesabına ekstra bir güvenlik katmanı ekle</p>
                                </div>
                                <button className="group flex items-center gap-4">
                                    <span className="text-10px font-semibold text-emerald-500   italic">AKTİF ET</span>
