            ...
            <aside className="w-72 bg-white border-r border-slate-200 flex flex-col">
                <div className="p-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <span className="text-lg font-black text-slate-900 leading-none block">Merchant Admin</span>
                            <span className="text-[10px] font-bold text-slate-400 tracking-wider uppercase">Vibrant Storefront</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-6">
                    <div className="bg-slate-50 p-4 rounded-3xl flex items-center gap-4 border border-white shadow-sm">
                        ...
                        <div className="flex-1 min-w-0">
                            <span className="text-sm font-black text-slate-900 block truncate leading-tight">{merchant?.companyName || 'Alex Rivera'}</span>
                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Pro Merchant</span>
                        </div>
